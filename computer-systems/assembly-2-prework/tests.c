...
void test_transpose(void) {
  int matrixin[2][3] = {{1, 2, 3}, {4, 5, 6}};
  int matrixcheck[3][2] = {{1, 4}, {2, 5}, {3, 6}};
  int matrixout[3][2] = {{0, 0}, {0, 0}, {0, 0}};
  transpose((int *)matrixin, (int *)matrixout, 2, 3);
  TEST_ASSERT_EQUAL_INT_ARRAY((int *)matrixcheck, (int *)matrixout, 6);
}
